/*
 * RoomOptionsModal Messages
 *
 * This contains all the text for the RoomOptionsModal component.
 */
import { defineMessages } from 'react-intl';

export default defineMessages({
  header: {
    id: 'app.components.RoomOptionsModal.header',
    defaultMessage: 'This is the RoomOptionsModal component !',
  },
  cancel: {
