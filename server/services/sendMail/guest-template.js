                  ...
                  <div style="Margin-left: 20px;Margin-right: 20px;">
                    <div style="mso-line-height-rule: exactly;mso-text-raise: 4px;">
                      <h1 style="Margin-top: 0;Margin-bottom: 0;font-style: normal;font-weight: normal;color: #565656;font-size: 30px;line-height: 38px;text-align: center;">
                        <strong>Welcome to haven</strong>&nbsp;</h1>
                      <p style="Margin-top: 20px;Margin-bottom: 0;">${firstName}, you have been registered as a haven user.&nbsp;</p>
                      <p style="Margin-top: 20px;Margin-bottom: 0;">Your login e-mail: ${email}
                        <br /> Password: ${password}</p>
                        <br /> User Id: ${userId}</p>
                        <br /> Hotel: ${hotelName}</p>
                      <p style="Margin-top: 20px;Margin-bottom: 20px;">Please log onto havenapp.co to&nbsp;change your password immediately.</p>
                    </div>
                  </div>
